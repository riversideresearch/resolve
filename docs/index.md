<div align="center">
    <picture style="width: 100%; height: auto;">
        <img src="assets/resolve_logo_white.png#only-dark">
        <img src="assets/resolve_logo_black.png#only-light">
    </picture>
</div>
...
This documentation website can guide you through the concepts, components, and [installation](installation.md) of **RESOLVE**. It also contains full end-to-end examples for [input synthesis](examples/input-synthesis.md), [reachability](examples/reachability.md) and [remediation](examples/remediation.md).
