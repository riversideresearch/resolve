...
struct StackFrame {
  ...
  StackFrame(KInstIterator caller, KInstIterator resume_pc, KFunction *kf);
...
public:
  ...
  void pushFrame(KInstIterator caller, KInstIterator resume_pc, KFunction *kf);
  void popFrame();
