...
StackFrame::StackFrame(KInstIterator _caller, KInstIterator _resume_pc, KFunction *_kf)
  : caller(_caller), resume_pc(_resume_pc), kf(_kf), callPathNode(0), 
...
void ExecutionState::pushFrame(KInstIterator caller, KInstIterator resume_pc, KFunction *kf) {
  stack.emplace_back(StackFrame(caller, resume_pc, kf));
}
