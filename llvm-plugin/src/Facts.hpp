...
struct Facts {
    ...
    void recordNodeProp(const std::string &nodeID, const std::string &key, const std::string &value) {
    ...
    void recordEdgeProp(const std::string &edgeID, const std::string &key, const std::string &value) {
