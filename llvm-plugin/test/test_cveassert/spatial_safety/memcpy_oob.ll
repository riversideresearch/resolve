; ModuleID = 'memcpy_oob.c'
source_filename = "memcpy_oob.c"
...
define dso_local i32 @main() #0 {
  ...
  %5 = call noalias ptr @malloc(i64 noundef 10) #4
  ...
  %12 = add i64 %9, %11
  %13 = call ptr @resolve_sanitize_memcpy(ptr %6, ptr %5, ptr %7, ptr @.str, i64 %12)
...
define internal ptr @resolve_sanitize_memcpy(ptr %0, ptr %1, ptr %2, ptr %3, i64 %4) {
  %6 = call i1 @resolve_check_bounds(ptr %3, ptr %2, i64 %4)
  %7 = call i1 @resolve_check_bounds(ptr %1, ptr %0, i64 %4)
  %8 = and i1 %6, %7
...
10:                                               ; preds = %5
  %11 = call ptr @memcpy(ptr %0, ptr %2, i64 %4)
  ret ptr %11
}
