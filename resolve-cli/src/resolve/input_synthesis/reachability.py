...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Run a reachability analysis pipeline on conditions generated by improve_CVE.py. All intermediate artifacts are written under a unique /tmp workspace and final results are copied to output_path.",
        epilog=f"""Examples:
